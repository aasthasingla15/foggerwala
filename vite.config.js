...
const destDirs = [
  'c:/Users/AASTHA/Downloads/termaweb/website/public/images',
  path.join(sourceDir, 'public/images')
];
...
try {
  if (fs.existsSync(sourceDir)) {
    ...
    console.log(`[Vite Config] Auto-copied ${copiedCount} images from workspace to all public/images folders!`);
  }
} catch (err) {
