...
const servicesData = [
  ...
  { id:11, title:'Fly Control', cat:'commercial', img:'/images/mosquitocontrol.png', icon: <Droplet />, desc:'UV fly killers, baiting, and sanitation programs for fly-free environments.' },
  ...
  { id:16, title:'Warehouse Pest Management', cat:'industrial', img:'/images/rodentcontrol.png', icon: <Activity />, desc:'Comprehensive pest programs to protect stored goods and maintain regulatory compliance.' },
  { id:17, title:'Hospital Pest Control', cat:'commercial', img:'/images/pharmaceuticalpestcontrol.png', icon: <Shield />, desc:'Discreet, safe, and highly effective pest control for healthcare environments.' },
  ...
  { id:19, title:'School Pest Control', cat:'commercial', img:'/images/antcontrol.png', icon: <Activity />, desc:'Child-safe pest management solutions for schools, colleges, and educational institutions.' },
  { id:20, title:'Office Pest Control', cat:'commercial', img:'/images/hotelcontrol.png', icon: <Zap />, desc:'Minimal disruption pest control programs that keep your workplace productive and pest-free.' },
